...
export function StaffManager({
  users,
  currentUserId,
  canManageSuper = false,
}: {
  users: StaffUser[];
  currentUserId: string;
  canManageSuper?: boolean;
}) {
  const manageableRoles = canManageSuper
    ? ROLES
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-gray-500">
        Một tài khoản có thể có nhiều vai trò (vd. <b>Admin + Tài xế</b>).
        Tích/bỏ tích để đổi vai trò.
      </p>
            ...
            >
              <div className="min-w-[35%] flex-1">
                <p className="font-semibold text-gray-900">
                  ...
                  {!u.isActive && (
                    <span className="ml-1 rounded bg-gray-200 px-1.5 text-[11px] text-gray-500">
                      Khóa
                    </span>
                  )}
                </p>
